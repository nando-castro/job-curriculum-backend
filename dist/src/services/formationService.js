...
function createFormation(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const dataFormation = Object.assign({}, data);
        const result = yield formationRepository.insert(dataFormation);
        return result;
    });
}
exports.createFormation = createFormation;
function getFormations(resumeId) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield formationRepository.findByResumeId(resumeId);
        return result;
    });
}
