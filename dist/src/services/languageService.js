...
function createLanguage(data) {
    return __awaiter(this, void 0, void 0, function* () {
        const dataLanguage = Object.assign({}, data);
        const result = yield languageRepository.insert(dataLanguage);
        return result;
    });
}
exports.createLanguage = createLanguage;
function getLanguages(resumeId) {
    return __awaiter(this, void 0, void 0, function* () {
        const result = yield languageRepository.findByResumeId(resumeId);
        return result;
    });
}
